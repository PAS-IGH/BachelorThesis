...
file_path_5mm_noDMG_edited = script_dir.parent / "testData" /"5mm"/"5mm_noDMG_05_11_2025_edited.csv" #that should also be in createTimeSeriesDataFrame, the read csv file should always be turned into a dataframe 
